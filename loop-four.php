<nav class="post-articles">
    <!-- ARTIGOS -->
    <div class="row list-articles left">

        <?php 
            $args = array( 'post_type' => 'artigos', 'posts_per_page' => 4, 'orderby' => 'date', 'offset' => 12 ); 
        ...
        <!-- 
        * Primeiro deve estar sem offset
        
        <article class="small-2 columns left">
                
            <div class="small-16 small-offset-1 columns this-post">
                <h5 class="cat-post small-18 left text-upp"><a href="#">Artigos</a></h5>
                <p class="title-post text-upp">
                    <a href="#" title="" class="white get-modal" data-reveal-id="article-modal" data-reveal>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic modi nostrum ex.</a>
                </p>
            </div>

            <small class="abstract-post text-upp small-16 small-offset-1 left font-lite">
                <a href="#" title="" data-reveal-id="article-modal" data-reveal>Lorem ipsum dolor sit amet, consectetur adipisicing elit</a>
            </small>
    ...
    <!-- PROJETOS -->
    <div class="list-projects row left small-pull-4">
        <?php 
            $args = array( 'post_type' => 'projetos', 'posts_per_page' => 3, 'orderby' => 'date', 'offset' => 9 ); 
            $loop = new WP_Query( $args );
            while ( $loop->have_posts() ) : $loop->the_post();
        ...
        <!--
        * Ultimo deve ter push igual a 2
        
        <article class="small-4 columns left small-push-2">
    ...
    <!-- PENSADOURO -->
    <div class="list-thought row left small-pull-2">
        <?php       
            $category_id = get_cat_ID( 'Pensadouro' );
            query_posts('showposts=4&category_name=pensadouro&offset=12'); 
        ...
        <article class="small-3 left columns this-thought" data-thumb="<?php echo $thumb; ?>" data-modalid="<?php echo returnId(); ?>">
            <header class="small-14 small-offset-2 left">
                ...
                <h6><a href="<?php echo esc_url( $category_link ); ?>" title="Pensadouro" class="white text-upp get-category-timeline" data-categoryid="<?php echo $category_id; ?>">Pensadouro</a></h6>
